    ...
    render() {
        return (
            <div id="button-container">
                ...
                <Row>  
                     <Col sm={6}>
                        <FlatButton label="Read the Rules"  onTouchTap={this.handleRulesOpen} primary={true} className="button-spacing" />
                    ...
                    <Col sm={6}>
                        <FlatButton label="Use the Checklist"  onTouchTap={this.handleDrawerToggle} primary={true} className="button-spacing" />
